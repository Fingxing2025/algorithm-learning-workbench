export const IPC_CHANNELS = {
  ...
  templateManagement: {
    inspectBatchStagingRecoveries: 'template-management:inspect-batch-staging-recoveries',
    recoverBatchStaging: 'template-management:recover-batch-staging',
    ...
    createBatchStaging: 'template-management:create-batch-staging',
    getBatchStaging: 'template-management:get-batch-staging',
    listBatchStagings: 'template-management:list-batch-stagings',
    continueBatchStaging: 'template-management:continue-batch-staging',
    retryBatchStaging: 'template-management:retry-batch-staging',
    updateBatchStagingItem: 'template-management:update-batch-staging-item',
    applyBatchStaging: 'template-management:apply-batch-staging',
    applyBatchStagingAiPlan: 'template-management:apply-batch-staging-ai-plan',
    discardBatchStaging: 'template-management:discard-batch-staging',
    previewBatchStagingAiPlan: 'template-management:preview-batch-staging-ai-plan',
    previewBatchStagingClassification: 'template-management:preview-batch-staging-classification',
    generateBatchStagingAiPlan: 'template-management:generate-batch-staging-ai-plan',
    cancelBatchStagingAiPlan: 'template-management:cancel-batch-staging-ai-plan',
    getBatchStagingAiDraft: 'template-management:get-batch-staging-ai-draft',
