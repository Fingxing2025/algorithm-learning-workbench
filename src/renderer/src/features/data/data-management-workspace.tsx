      ...
      <div className="min-h-0 flex-1 overflow-y-auto p-5">
        <div className="mx-auto grid max-w-[1120px] gap-4">
            ...
            {lifecycle ? (
              <>
                ...
                <DataInterruptedRecoveryPanel
                  ...
                  disabled={operation !== null}
                  interruptedOperationCount={lifecycle.interruptedOperationCount}
          ...
          <DataBackupRestorePanel
            ...
            includeTemplateSources={includeTemplateSources}
            ...
            onIncludeTemplateSourcesChange={setIncludeTemplateSources}
            onPreviewRestore={() =>
