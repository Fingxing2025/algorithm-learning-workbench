...
- G1 adds deterministic template-book export to `.tex`, an optional compact/highlighted PDF generated by the built-in Electron print engine, and an optional RTF-compatible `.doc`. RC4 also audits semantically duplicated template categories and streamlines template metadata around problem, input, output, complexity, tags, and private notes.
