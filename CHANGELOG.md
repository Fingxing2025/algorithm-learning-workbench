...
- Session F 第一切片完成行为保持的 Renderer 代码健康拆分：应用路由决策、全局快捷键、对话框焦点状态、应用外壳、布局状态、工作区视图和工作区路由分别归位。
- 新增快捷键解析与工作区路由纯逻辑测试；保持现有产品模块、视觉系统、IPC、SQLite schema 和安全边界不变。
- 当前源码通过 209 项 Vitest、3 项发布脚本测试和 54 项常规 Electron E2E；本切片未重新打包。
